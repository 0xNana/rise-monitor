...
import DailyAggregatesTable from '@/components/DailyAggregatesTable'
    ...
    <div className="flex h-full w-full observability-grid">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-4">
          ...
          <DailyAggregatesTable timePeriod={timePeriod} />
          <div className="flex justify-between items-center pt-2 pb-6 border-t border-strict-border/30">
            <span className="text-[10px] font-mono text-muted-slate uppercase tracking-tight opacity-70 italic">
