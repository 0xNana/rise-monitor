    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-auto">
      <div className="strict-card p-4">
        ...
        <div className="text-xl font-bold text-white font-mono">
          {peakP99 > 0 ? `${peakP99.toFixed(1)}` : '0'}<span className="text-[10px] text-slate-500 ml-1">MS</span>
        </div>
      ...
      <div className="strict-card p-4">
        ...
        <div className="text-xl font-bold text-white font-mono">
          {globalAvg > 0 ? `${globalAvg.toFixed(1)}` : '0'}<span className="text-[10px] text-slate-500 ml-1">MS</span>
        </div>
        <div className="mt-2 h-1 bg-white/5 overflow-hidden">
      ...
      <div className="strict-card p-4">
        ...
        <div className="text-xl font-bold text-white font-mono">
          {errorRate.toFixed(3)}<span className="text-[10px] text-slate-500 ml-1">%</span>
        </div>
        <div className="mt-2 h-1 bg-white/5 overflow-hidden">
      ...
      <div className="strict-card p-4">
        ...
        <div className="text-xl font-bold text-white font-mono">
          {sampleCount > 0 ? `${(sampleCount / 1000000).toFixed(1)}M` : '0'}<span className="text-[10px] text-slate-500 ml-1">REQ</span>
        </div>
        <div className="mt-2 h-1 bg-white/5 overflow-hidden">
